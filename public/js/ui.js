const init = () => {
    ...
    const handleFileMessasge = () => {
        const file = document.querySelector(".input-file");
        const fileMessage = document.querySelector(".input-file--message");
    ...
    applicationForm.addEventListener("submit", function (event) {
        ...
        fetch("/api/store", {
            ...
            .catch((error) => {
                ...
                document.getElementById("message_error").innerHTML =
                    "Wystąpił problem z wysłaniem zgłoszenia. Spróbuj ponownie.";
                formDiv.classList.add("formularz-message--error-active");
                button.removeAttribute("disabled", "");
                button.classList.remove("spinner");
            });
    ...
    const contactSuccessButton = document.getElementById(
